...
import com.timekpr.agent.enforcement.TimeExemptionResolver
...
class OtpLockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isSecondaryMode = configStore.load().managementMode == com.timekpr.agent.config.AgentConfigStore.MANAGEMENT_MODE_SECONDARY_USERS

...
import com.guardian.agent.vpn.BlockBurstNotifier
import com.guardian.agent.vpn.DomainGrouping
...
object BlockedDomainOverlay {
    ...
    private fun showInternal(
        ...
        return try {
            val themedContext = ContextThemeWrapper(context, R.style.Theme_GuardianAgent)

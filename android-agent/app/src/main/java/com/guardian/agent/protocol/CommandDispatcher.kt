...
import com.guardian.agent.discovery.DiscoveredApp
import com.guardian.agent.discovery.InstalledAppsDiscovery
...
class CommandDispatcher(
    ...
    private val app: GuardianApplication = GuardianApplication.from(context)

...
data class AgentUpdateRequest(
    ...
    fun resolvedApkUrl(): String? {
        ...
        return "https://github.com/$DEFAULT_GITHUB_REPO/releases/download/$tag/guardian-android-agent-$tag.apk"
    }
    ...
    fun resolvedChecksumUrl(): String? {
        ...
        val tag = if (version.startsWith("v")) version else "v$version"
        return "https://github.com/$DEFAULT_GITHUB_REPO/releases/download/$tag/guardian-android-agent-$tag.signature-checksum"
    }

...
import com.guardian.agent.monitor.ApprovalRequestDeduper
import com.guardian.agent.monitor.ForegroundAppTracker
import com.guardian.agent.policy.UidPolicy
import com.guardian.agent.ui.BlockedDomainOverlay
...
object BlockNotificationCoordinator {
    ...
    private fun currentUidPolicy(context: Context): UidPolicy? {
        val domainStore = GuardianApplication.from(context).domainPolicyStore

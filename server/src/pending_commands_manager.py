...
def rebuild_command_args(row: PendingCommand) -> dict | None:
    ...
    if action == 'sync_linux_device_policy':
        from src.linux_device_policy_manager import build_device_policy_payload, get_or_create_policy
    ...
    if action == 'sync_android_device_policy':
        from src.android_device_policy_manager import build_device_policy_payload, get_or_create_policy
...
def _mark_policy_synced(row: PendingCommand, success: bool, message: str | None = None) -> None:
    ...
    if action == 'sync_linux_device_policy':
        from src.linux_device_policy_manager import _get_policy_row
        ...
        from src.android_device_policy_manager import _get_policy_row

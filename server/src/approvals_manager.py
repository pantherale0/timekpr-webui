...
from src.blocklist_helper import normalize_domain
...
def _normalize_package_target(value):
    ...
    if raw.startswith(ANDROID_PACKAGE_PREFIX):
        ...
        package_name = raw
    from src.apparmor_manager import _validate_android_package_name
...
def _infer_app_launch_target_kind(mapping, target_value):
    from src.apparmor_manager import _device_platform
    from src.database import AppPolicy

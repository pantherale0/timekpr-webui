...
class BackgroundTaskManager:
    ...
    def _run_task_cycle(self):
        ...
        from src.agent.pending_commands import expire_stale_commands
    ...
    def _prune_expired_invites(self):
        ...
        try:
            from src.models import HouseholdInvite, ManagedUserShareInvite
    ...
    def _prune_old_alerts(self):
        ...
        try:
            from src.common.settings import _get_alert_retention_days
    ...
    def _fetch_youtube_categories(self):
        ...
        try:
            from src.common.settings import _get_youtube_api_key
    ...
    def _prune_video_history(self):
        ...
        try:
            from src.common.settings import _get_video_history_retention_days
    ...
    def _prune_web_history(self):
        ...
        try:
            from src.common.settings import _get_web_history_retention_days
    ...
    def refresh_external_blocklist_source(self, source_id, force=False):
        ...
        from src.common.url_safety import is_safe_outbound_url
    ...
    def notify_domain_policy_hint(self, household_id: int, system_ids=None, reason='server_update'):
        ...
        for system_id in target_system_ids:
            ...
            if not AgentConnectionManager.is_online(system_id):
                from src.agent.pending_commands import enqueue_domain_reconcile
    ...
    def _sync_domain_policy_device(self, system_id, mapping_state, source_state_map, source_revisions=None):
        ...
        for mapping, assigned_source_ids, _summary in mapping_state:
            ...
            try:
                ...
                from src.models import MappingApprovalSettings
    ...
    def _sync_android_device_policy_system(self, system_id):
        from src.policy.android import sync_android_device_policies_for_system

        return sync_android_device_policies_for_system(system_id)

    def _sync_linux_device_policy_system(self, system_id):
        from src.policy.linux import sync_linux_device_policies_for_system

        return sync_linux_device_policies_for_system(system_id)

    def _sync_screenshot_policy_system(self, system_id):
        from src.device.screenshot_settings import sync_screenshot_policies_for_system

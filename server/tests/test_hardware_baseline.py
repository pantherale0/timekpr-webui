...
def test_apply_hardware_baseline_offline(auth_client, hardware_device, monkeypatch):
    monkeypatch.setattr(
        'src.device.hardware_baseline.AgentConnectionManager.is_online',
...
def test_apply_hardware_baseline_persists_receipt(auth_client, hardware_device, monkeypatch):
    ...
    monkeypatch.setattr('src.device.hardware_baseline.AgentConnectionManager.is_online', lambda _system_id: True)
    monkeypatch.setattr('src.agent.helper.AgentClient.apply_hardware_baseline', fake_apply)
...
def test_audit_hardware_baseline_persists_receipt(auth_client, hardware_device, monkeypatch):
    ...
    monkeypatch.setattr('src.device.hardware_baseline.AgentConnectionManager.is_online', lambda _system_id: True)
    monkeypatch.setattr('src.agent.helper.AgentClient.audit_hardware_baseline', fake_audit)
